...
@ActiveProfiles("test")
public class TestingHeaderHolder {
    ...
    @Test
    public void givenAuthRequestWithPaleoOnOnlyLabo_shouldInterceptParcHeader() throws Exception {
    ...
    @WithMockUser(username="unPaleo",roles={"PALEO"})
    @Test
    public void givenAuthRequestWithPaleoOnOnlyLaboWithoutCorrelationId_shouldCorrelationIdBeenCreated() throws Exception {
        mvc.perform(get("/test/onlylabo").contentType(MediaType.APPLICATION_JSON)
                .header("Parc", Parc.HAWAII));
